...
slides:
  - index: 0
    titre: "Récap · ce que vous avez maintenant"
...
quiz_inline:
  - after_slide: 2
    ...
    answer: 2
    explanation: "La boucle amplificatrice produit des erreurs non vérifiées, c'est une question de fréquence. La reddition cognitive va plus loin : l'équipe perd progressivement la compétence même de vérification. La question n'est plus « l'IA se trompe-t-elle ? » mais « sommes-nous encore capables de le détecter ? »."
  - after_slide: 3
    question: "L'IMIA mesure principalement..."
    options:
      - "Le nombre de collaborateurs qui utilisent l'IA dans l'organisation"
      - "La capacité de l'organisation à gouverner ses pratiques IA dans la durée, ce qu'elle sait faire, pas ce qu'elle fait"
  ...
  - after_slide: 4
    ...
    answer: 1
    explanation: "Un individu bien formé dans un système qui ne l'est pas finit souvent par s'aligner sur le système. La formation donne la méthode individuelle. Ce qui manque, c'est un travail sur le système lui-même, les boucles, les normes collectives, la maturité organisationnelle mesurée par l'IMIA. C'est précisément le rôle de l'AI Practice Steward."
quiz_final:
  - question: "Une « capacité nouvelle crée une responsabilité nouvelle ». Quel est le bon exemple de cette logique ?"
    options:
      - "Plus un outil est performant, moins l'utilisateur a besoin de le superviser"
      - "Un chirurgien qui intègre un assistant robotisé est davantage responsable, pas moins"
      - "L'IA déplace la responsabilité de l'utilisateur vers le fournisseur de l'outil"
      - "Une fois l'outil maîtrisé, la supervision devient optionnelle"
    answer: 1
    explanation: "Quand un assistant est intégré dans le travail, la responsabilité ne disparaît pas, elle se déplace vers le haut. Le chirurgien qui choisit d'intégrer un assistant robotisé en contrôle les conditions d'utilisation. Il en répond davantage."
  - question: "Qu'est-ce qui caractérise la boucle amplificatrice ?"
    options:
      - "Une augmentation contrôlée des usages IA dans une organisation"
      - "Une croissance des usages avec une vérification qui diminue silencieusement, jusqu'à un choc correcteur"
      - "Un effet positif d'apprentissage collectif autour de l'IA"
      - "Une dépendance volontaire à un outil spécifique"
    answer: 1
    explanation: "La boucle amplificatrice s'installe sans décision : usage ↑, vérification ↓, par habitude et manque de temps. Elle ne s'arrête pas d'elle-même, elle s'emballe jusqu'à ce qu'une erreur non détectée cause un tort visible."
  - question: "Qu'est-ce que la reddition cognitive ?"
    options:
      - "Une décision collective de déléguer certaines tâches à l'IA"
      - "L'atrophie progressive de la capacité collective à vérifier les sorties de l'IA"
      - "Un état de fatigue mentale provoqué par l'usage intensif de l'IA"
      - "L'abandon volontaire d'un outil IA jugé trop coûteux"
    answer: 1
    explanation: "La reddition cognitive n'est pas un choix. C'est une accumulation d'usages individuels qui aboutit à ce que l'équipe perde la compétence même de vérification. La question bascule de « l'IA se trompe-t-elle ? » à « sommes-nous encore capables de le détecter ? »."
  - question: "Quelle est la différence centrale entre S.F.O.I. et IMIA ?"
    options:
      - "S.F.O.I. concerne l'individu, IMIA concerne l'équipe"
      - "S.F.O.I. est la méthode personnelle de travail ; IMIA est la carte de maturité organisationnelle"
      - "IMIA est une version simplifiée de S.F.O.I."
      - "S.F.O.I. mesure les usages, IMIA mesure les outils"
    answer: 1
    explanation: "S.F.O.I. dit comment on travaille, quatre actes au quotidien. L'IMIA dit où en est l'organisation, un score sur 100, cinq dimensions, mesuré dans le temps. La méthode est la même ; ce qui change, c'est l'échelle d'observation."
  ...
  - question: "Qu'est-ce qui distingue structurellement un AI Practice Steward d'un consultant IA ?"
    options:
      ...
      - "Le consultant prescrit une solution pour un périmètre limité ; le steward assume un périmètre dans la durée et travaille sur le système qui produit les problèmes"
      - "Le steward est interne à l'organisation, le consultant est externe"
  ...
  - question: "Le succès d'une mission The B Context se mesure à..."
    options:
      ...
      - "La capacité du client à se passer du steward, autonomie de l'organisation"
      - "Le score IMIA atteint, indépendamment de la durée"
    answer: 2
    explanation: "Le steward ne cherche pas à durer. Il installe une capacité collective qui survit à son départ. Le succès se mesure à l'autonomie produite, pas à la reconduction. C'est ce qui distingue le stewardship du conseil traditionnel."
  - question: "Vous avez fini cette formation. Quel est le réflexe le plus juste à avoir maintenant ?"
    options:
      - "Diffuser la méthode S.F.O.I. à tous mes collègues pour qu'ils l'appliquent"
      - "Appliquer S.F.O.I. à mes propres livrables, et observer les boucles autour de moi sans les interrompre seul"
      - "Demander à mon organisation de nommer un AI Practice Steward immédiatement"
      - "Continuer à utiliser l'IA comme avant, la formation était un complément, pas un changement"
    answer: 1
    explanation: "La formation vous donne une méthode personnelle. Diffuser seul ne marche pas, un individu ne change pas un système. Mais appliquer S.F.O.I. à votre travail, et apprendre à voir les boucles dans votre équipe, c'est ce qui prépare la conversation organisationnelle quand elle viendra."
---

## Récap · ce que vous avez maintenant

Vous y êtes. Dernier bloc. Et il est un peu différent des autres.
...
## Ce que la formation ne peut pas résoudre
...
## Le rôle que ça crée · l'AI Practice Steward
